...
export class IntegrationService {
    ...
    /**
     * Update integration Sync form
     *
     * @param integrationId
     * @param formJson
     */
    updateIntegrationSyncForm(
        integrationId: string,
        formJSON: IntegrationSyncForm
    ) {
        const api = this._config?.apiConfig?.baseUrl;
        // <EcommifyApiResponse<Integration>>
        return this._httpClient
            .put<EcommifyApiResponse<IntegrationSyncForm>>(`${api}/admin/integration/${integrationId}/form`, formJSON)
            .pipe(
                tap(response => {
    ...
    /**
     * get Integration Sync form
     *
     * @param integrationId
     */
    getIntegrationSyncForm(integrationId: string) {
        const api = this._config?.apiConfig?.baseUrl;
        // <EcommifyApiResponse<Integration>>
        return this._httpClient
            .get<EcommifyApiResponse<IntegrationSyncForm>>(`${api}/admin/integration/${integrationId}/form`)
            .pipe(
                tap(response => {
                    console.log('response', response);
                })
    ...
    /**
     * get Integration Sync form Value List
     *
     * @param integrationId
     */
    getIntegrationSyncFormValueList(integrationId: string) {
        const api = this._config?.apiConfig?.serviceUrl;
        // <EcommifyApiResponse<Integration>>
        return this._httpClient
            .get<EcommifyApiResponse<ValuesList>>(`${api}/admin/integration/${integrationId}/values_list`)
            .pipe(
                tap(response => {
