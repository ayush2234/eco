...
export class TenantsGridComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        // Get the categories
        this._tenantsService.categories$
            .pipe(takeUntil(this._unsubscribeAll))
        ...
        // Get the products
        this.products$ = this._tenantsService.products$;
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._tenantsService.getProducts(
                        0,
                        10,
                        'name',
                        'asc',
    ...
    toggleDetails(productId: string): void {
        ...
        this._tenantsService.getProductById(productId).subscribe((product) => {
    ...
    createTag(title: string): void {
        ...
        this._tenantsService.createTag(tag).subscribe((response) => {
    ...
    createProduct(): void {
        // Create the product
        this._tenantsService.createProduct().subscribe((newProduct) => {
            // Go to new product
    ...
    deleteSelectedProduct(): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._tenantsService.deleteProduct(product.id).subscribe(() => {
                    // Close the details
                    this.closeDetails();
                });
            }
